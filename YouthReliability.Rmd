...
```{r}
# needs free Roboto Condensed font, download below:
# https://fonts.google.com/specimen/Roboto+Condensed
 
# uncomment below to run figure from paper version:
...
# save plot
ggsave("figs/Fig 2. DTI_ICC.pdf", dpi = 1000,
       width = 7.25, height = 5)
